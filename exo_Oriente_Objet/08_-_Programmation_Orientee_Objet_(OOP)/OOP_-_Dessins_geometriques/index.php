                ...
                <tr>
                    <td align="left" valign="top">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td>Largeur :</td>
                                <td><input min="0" name="width" type="number" value="<?php echo isset( $width ) && $width>=0 ? $width : 100; ?>"></td>
                            </tr>
                            <tr>
                                <td>Hauteur :</td>
                                <td><input min="0" name="height" type="number" value="<?php echo isset( $height ) && $height>=0 ? $height : 50; ?>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Rayon :</td>
                                <td><input min="0" name="radius" type="number" value="<?php echo isset( $radius ) && $radius>=0 ? $radius : 60; ?>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Côté :</td>
                                <td><input min="0" name="side" type="number" value="<?php echo isset( $side ) && $side>=0 ? $side : 60; ?>"></td>
                            </tr>
                        </table>
                    </td>
                    <td align="left" valign="top">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td>Abscisse :</td>
                                <td><input min="0" name="x" type="number" value="<?php echo isset( $X ) && $X>=0 ? $X : 150; ?>"></td>
                            </tr>
                            <tr>
                                <td>Ordonnée :</td>
                                <td><input min="0" name="y" type="number" value="<?php echo isset( $Y ) && $Y>=0 ? $Y : 150; ?>"></td>
                            </tr>
                            <tr>
                                <td>Rouge :</td>
                                <td><input min="0" max="255" name="r" value="<?php echo isset( $R ) && $R>=0 && $R<=255 ? $R : 250; ?>"></td>
                            </tr>
                            <tr>
                                <td>Vert :</td>
                                <td><input min="0" max="255" name="g" value="<?php echo isset( $G ) && $G>=0 && $G<=255 ? $G : 250; ?>"></td>
                            </tr>
                            <tr>
                                <td>Bleu :</td>
                                <td><input min="0" max="255" name="b" value="<?php echo isset( $B ) && $B>=0 && $B<=255 ? $B : 150; ?>"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
