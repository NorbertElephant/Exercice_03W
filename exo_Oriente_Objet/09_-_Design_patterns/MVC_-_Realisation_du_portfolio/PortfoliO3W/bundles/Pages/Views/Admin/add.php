<article role="article" style="white-space: nowrap;">
    <header>
        <hgroup>
            <h1 id="h1"><?php echo _( 'Add new page' ); ?></h1>
            <hr class="hr">
        </hgroup>
    </header>
...
<form action="<?php app_info( 'url' ); ?>pages/adding/" class="form" enctype="multipart/form-data" method="post">
    ...
    <fieldset class="fieldset">
        ...
        <div class="wrapper">
        <input type="text" name='type'  value="page" readonly >
        </div>
    </fieldset>
    ...
    <fieldset class="fieldset">
        ...
        <div class="wrapper">
        <input type="text" name='format'  value="nav_menu" readonly >
        </div>
    </fieldset>
    <fieldset class="fieldset">
    ...
    <div style="text-align:right;">
        <button class="button add dark" type="submit"><span class="inner"><?php echo _( 'Add page' ); ?></span></button>
    </div>
</form>
</article>
