...
<form action="<?php app_info( 'url' ); ?>posts/addingCategory/" class="form" enctype="multipart/form-data" method="post">
    ...
    <div style="text-align:right;">
        <button class="button add dark" type="submit"><span class="inner"><?php echo _( 'Add category' ); ?></span></button>
    </div>
</form>
</article>