<article role="article" style="white-space: nowrap;">
    <header>
        <hgroup>
            <h1 id="h1"><?php echo _( 'Edit post' ); ?></h1>
            <hr class="hr">
    ...
    <form action="<?php app_info( 'url' ); ?>posts/updating/<?php echo $posts->getId(); ?>/" class="form" enctype="multipart/form-data" method="post">
    ...
    <div style="text-align:right;">
        <button class="button add dark" type="submit"><span class="inner"><?php echo _( 'Modify posts' ); ?></span></button>
    </div>
</form>
</article>